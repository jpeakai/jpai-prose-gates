...
| [PRS-0016](0016-a-shared-helper-sits-on-its-own-side.md) | A helper shared by rules sits on the side of the rule it serves | superseded |
| [PRS-0017](0017-modules-group-by-what-a-function-takes.md) | A module groups functions by what they take, not by who calls them | accepted |
# By group
...
* [PRS-0016](0016-a-shared-helper-sits-on-its-own-side.md) - Helpers that read views and sentences live in rules/utils.ts, and helpers that read source offsets live in fix/
* [PRS-0017](0017-modules-group-by-what-a-function-takes.md) - Shared code sits in the layer whose data it reads, and the layers import strictly downwards
## fixing
...
* PRS-0008 --depended_on_by--> PRS-0017
...
* PRS-0016 --superseded_by--> PRS-0017
* PRS-0016 --depends_on--> PRS-0015
* PRS-0016 --depends_on--> PRS-0008
* PRS-0017 --supersedes--> PRS-0016
* PRS-0017 --depends_on--> PRS-0008
